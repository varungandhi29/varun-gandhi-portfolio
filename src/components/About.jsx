...
export default function About() {
  return (
    <section id="about" className="py-24 relative bg-[#0B0E14] border-t border-[#1E2638]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          >
            <div className="space-y-4 text-[#8B93A7] leading-relaxed font-sans text-base">
              <p>
                I am a final-year <strong className="text-[#E6E9EF] font-semibold">B.Tech Information Technology</strong> student 
                at <strong className="text-[#3ED6C4] font-semibold">Parul University</strong> in Vadodara, Gujarat, India, graduating in May 2027.
              </p>

              <p>
                Following a <strong className="text-[#E8A33D] font-semibold">Diploma-to-Degree (lateral entry) pathway</strong>, 
              ...
              <p>
                My technical specialization centers on <strong className="text-[#E6E9EF]">Cloud Security & Infrastructure Auditing</strong>. 
                I design and build tools for automated <strong className="text-[#3ED6C4]">AWS IAM misconfiguration detection</strong>, 
            ...
            <div className="pt-4 border-t border-[#1E2638]">
              <div className="p-4 rounded-xl bg-[#0B0E14] border border-[#4ADE80]/30 flex items-start gap-3.5">
          ...
          >
            ...
            <div className="tech-card p-6 rounded-2xl space-y-3">
              <div className="flex items-center gap-2 text-[#E8A33D] font-mono text-xs font-semibold">
            ...
            <div className="tech-card p-6 rounded-2xl space-y-3">
              <div className="flex items-center gap-2 text-[#3ED6C4] font-mono text-xs font-semibold">
            ...
            <div className="tech-card p-6 rounded-2xl space-y-3">
              <div className="flex items-center gap-2 text-[#E6E9EF] font-mono text-xs font-semibold">
                <MapPin className="w-4 h-4 text-[#3ED6C4]" />
                <span>LOCATION & DIRECT CHANNELS</span>
              </div>
              <div className="text-xs text-[#8B93A7] space-y-2 font-sans">
                <div className="text-[#E6E9EF]">Vadodara, Gujarat, India</div>
                <div className="flex items-center gap-2">
                  <Mail className="w-3.5 h-3.5 text-[#3ED6C4]" />
                  <a href="mailto:2006varungandhi@gmail.com" className="text-[#3ED6C4] hover:underline">2006varungandhi@gmail.com</a>
                </div>
                <div className="flex items-center gap-2">
                  <Phone className="w-3.5 h-3.5 text-[#4ADE80]" />
                  <a href="tel:+919099604679" className="hover:text-[#E6E9EF] transition-colors">+91 90996 04679</a>
                </div>
              </div>
            </div>
