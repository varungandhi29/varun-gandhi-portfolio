        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          >
            ...
            <div className="ent-card p-7 rounded-2xl space-y-4">
              <div className="flex items-center justify-between border-b border-slate-100 pb-3">
                <span className="flex items-center gap-2 text-blue-700 font-bold text-xs">
                  <Mail className="w-4 h-4 text-blue-600" />
                  Primary Email
                </span>
                <span className="text-emerald-700 text-xs font-semibold">Direct Inbox</span>
              </div>

              <div>
                <p className="text-xs text-slate-500 mb-1">Direct Email Address:</p>
                <a
              ...
              <button
                ...
                className="w-full text-xs font-bold py-2.5 px-3 rounded-xl bg-slate-50 border border-slate-200 hover:border-blue-500 text-slate-800 flex items-center justify-center gap-2 transition-all shadow-sm"
              >
                {copied ? (
                  <>
            ...
            <div className="ent-card p-7 rounded-2xl space-y-4">
              ...
              <div className="space-y-3">
                <a
                  ...
                  className="p-3.5 rounded-xl bg-slate-50 border border-slate-200 hover:border-blue-400 flex items-center justify-between group transition-all"
                >
                  ...
                  <span className="text-xs text-slate-400 group-hover:text-blue-600">Open ↗</span>
                </a>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-3.5 rounded-xl bg-slate-50 border border-slate-200 hover:border-emerald-400 flex items-center justify-between group transition-all"
                >
                  <div className="flex items-center gap-3 text-xs font-bold text-slate-800">
                  ...
                  <span className="text-xs text-slate-400 group-hover:text-emerald-600">Connect ↗</span>
                </a>
          ...
          >
            <div className="flex items-center justify-between border-b border-slate-100 pb-4 text-xs">
              ...
              <span className="text-slate-500">Via Native Email</span>
            </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-sm text-slate-900 font-sans focus:outline-none focus:border-blue-500 focus:bg-white focus:ring-1 focus:ring-blue-500 transition-colors"
                  />
                </div>
