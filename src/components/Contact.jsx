...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-24 relative bg-[#1a2234] border-t border-[#334155]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          >
            ...
            <div className="tech-card p-7 rounded-2xl space-y-4">
              <div className="flex items-center justify-between border-b border-[#334155] pb-3">
                <span className="flex items-center gap-2 text-[#2dd4bf] font-mono font-bold text-xs">
              ...
              <div>
                <p className="text-xs text-[#cbd5e1] mb-1">Direct Email Address:</p>
                <a
                  href={`mailto:${emailAddress}`}
                  className="text-base font-bold text-[#f8fafc] hover:text-[#2dd4bf] transition-colors break-all"
                >
                  {emailAddress}
                </a>
              </div>
              ...
              <button
                ...
                className="w-full text-xs font-mono font-bold py-2.5 px-3 rounded-xl bg-[#1a2234] border border-[#334155] hover:border-[#2dd4bf]/50 text-[#f8fafc] flex items-center justify-center gap-2 transition-all"
              >
                {copied ? (
                  <>
            ...
            <div className="tech-card p-7 rounded-2xl space-y-4">
              ...
              <div className="space-y-3">
                <a
                  ...
                  className="p-3.5 rounded-xl bg-[#1a2234] border border-[#334155] hover:border-[#2dd4bf]/50 flex items-center justify-between group transition-all"
                >
                  ...
                  <span className="text-xs text-[#cbd5e1] group-hover:text-[#2dd4bf]">Open ↗</span>
                </a>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-3.5 rounded-xl bg-[#1a2234] border border-[#334155] hover:border-[#4ade80]/50 flex items-center justify-between group transition-all"
                >
                  <div className="flex items-center gap-3 text-xs font-mono font-medium text-[#f8fafc]">
                  ...
                  <span className="text-xs text-[#cbd5e1] group-hover:text-[#4ade80]">Connect ↗</span>
                </a>
          ...
          >
            <div className="flex items-center justify-between border-b border-[#334155] pb-4 text-xs font-mono">
              <div className="flex items-center gap-2 font-bold text-[#f8fafc]">
                <MessageSquare className="w-4 h-4 text-[#2dd4bf]" />
                <span>SEND DIRECT MESSAGE</span>
              </div>
              <span className="text-[#cbd5e1]">Email Delivery</span>
            </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-[#1a2234] border border-[#334155] rounded-xl px-4 py-2.5 text-sm text-[#f8fafc] font-sans focus:outline-none focus:border-[#2dd4bf] focus:ring-1 focus:ring-[#2dd4bf] transition-colors"
                  />
                </div>
            ...
            <p className="text-[11px] text-[#cbd5e1] text-center font-mono">
