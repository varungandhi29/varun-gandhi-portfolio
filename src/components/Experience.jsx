...
export default function Experience() {
  ...
  return (
    <section id="experience" className="py-24 relative bg-white border-t border-slate-200/80">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-6 border-b border-slate-100">
            ...
            <div className="text-xs text-slate-700 bg-slate-50 px-3.5 py-2 rounded-xl border border-slate-200 flex items-center gap-2 self-start md:self-auto font-sans font-semibold shadow-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {internProjects.map((project) => {
              ...
              return (
                <div
                  key={project.title}
                  className="p-5 rounded-2xl bg-slate-50 border border-slate-200 flex flex-col justify-between space-y-4 hover:border-blue-400 hover:bg-blue-50/30 transition-all group shadow-sm"
                >
                  <div className="space-y-3">
                    ...
                    <div className="inline-flex items-center gap-1.5 text-[11px] text-emerald-700 bg-emerald-50 px-2.5 py-0.5 rounded-md border border-emerald-200 font-semibold">
                  ...
                  <div className="space-y-3 pt-3 border-t border-slate-200">
                    ...
                    <a
                      ...
                      className="inline-flex items-center gap-1.5 text-xs text-slate-800 hover:text-blue-600 transition-colors font-bold"
                    >
